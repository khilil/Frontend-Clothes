    ...
    <main className="min-h-screen bg-background text-text-primary font-secondary selection:bg-accent selection:text-primary">
      ...
      <section className="py-20 md:py-32 px-6 bg-background">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl md:text-5xl font-primary tracking-wide text-text-primary mb-8">
            WELCOME TO <span className="text-accent">FENRIR ERA</span>
          </h2>
          <p className="text-text-secondary text-base md:text-lg leading-relaxed md:leading-[2] font-light tracking-wide">
      ...
      <section className="py-20 md:py-32 px-6 bg-secondary/30 border-y border-border-subtle">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            <h2 className="text-4xl md:text-5xl font-display italic text-text-primary leading-tight">
      ...
      <section className="py-24 md:py-32 px-6 bg-background">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="bg-secondary/40 p-12 md:p-16 rounded-2xl border border-[#2a2a2a] hover:border-accent/40 transition-colors duration-500 group shadow-lg shadow-black/20 hover:-translate-y-2 transform">
            ...
            <p className="text-text-secondary text-lg leading-relaxed group-hover:text-text-primary transition-colors duration-500">
      ...
      {/* 5. Why Choose Us */}
      <section className="py-24 md:py-32 px-6 bg-primary border-t border-border-subtle">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 md:mb-24">
            <h2 className="text-xs tracking-[0.4em] uppercase text-text-secondary mb-4">The Fenrir Standard</h2>
            <h3 className="text-4xl md:text-5xl font-display italic text-text-primary">Why Choose Us.</h3>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={idx} className="bg-secondary/20 p-10 rounded-2xl text-center border border-transparent hover:border-accent/20 hover:bg-secondary/40 transition-all duration-500 group">
                ...
                <h4 className="text-xl font-primary tracking-wide text-text-primary mb-4">{feature.title}</h4>
      ...
      <section className="relative py-32 px-6 overflow-hidden flex items-center justify-center bg-secondary">
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto">
          <h2 className="text-5xl md:text-7xl font-primary text-text-primary uppercase tracking-wider mb-8 drop-shadow-lg">
            Join the <span className="text-accent italic font-display lowercase pl-2">Fenrir Era</span>
          </h2>
          <p className="text-lg md:text-xl text-text-secondary mb-12 font-light">
