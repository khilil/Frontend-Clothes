...
export const ProductSuggestions = ({ product }) => {
  ...
  return (
    <section className="py-24 md:py-40 bg-white border-t border-neutral-100 relative overflow-hidden">
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 relative z-10">
        <header className="mb-20 md:mb-28 max-w-4xl">
          ...
          >
            ...
            <h2 className="text-6xl md:text-[8rem] lg:text-[10rem] font-impact tracking-tighter uppercase leading-[0.8] mb-4 text-neutral-900">
              EXPLORE <br /> <span className="text-transparent" style={{ WebkitTextStroke: '1px #e5e5e5' }}>COLLECTION</span>
            </h2>
            <p className="text-[11px] md:text-[13px] font-bold uppercase tracking-[0.3em] text-neutral-400 max-w-xl leading-relaxed">
        ...
        <div ref={observerTarget} className="mt-32 flex flex-col items-center justify-center gap-8 py-20 border-t border-neutral-100">
          {hasMore ? (
            <>
            ...
            <div className="text-center space-y-4">
              <span className="text-[10px] font-black uppercase tracking-[0.4em] text-neutral-300">Discovery Feed Complete</span>
              <div className="w-24 h-[1px] bg-neutral-100 mx-auto"></div>
            </div>
          )}
        </div>
      </div>
