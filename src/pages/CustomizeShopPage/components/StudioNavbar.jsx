...
export default function StudioNavbar() {
    ...
    return (
        <nav className="w-full md:w-20 bg-[#fcfbf9] border-t md:border-t-0 md:border-r border-black/5 flex md:flex-col items-center justify-around md:justify-start py-2 md:py-6 md:gap-8 z-50">
