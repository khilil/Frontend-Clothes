            ...
            <div className="max-w-[1800px] mx-auto px-4 md:px-12">
                ...
                <div className="mb-20 text-center">
                    <motion.div
                        ...
                        className="space-y-4"
                    >
                        <span className="text-[10px] md:text-xs font-black tracking-[0.6em] text-[#d4c4b1] uppercase">Archive Discovery</span>
                ...
                <div className="relative">
                    ...
                    {loadingMore && (
                        <div className="flex flex-col items-center gap-6 py-20">
                            <div className="w-32 h-[1px] bg-white/5 relative overflow-hidden">
                                <motion.div
                                    className="absolute inset-0 bg-[#d4c4b1]"
                                    animate={{ x: ["-100%", "100%"] }}
                                    transition={{ repeat: Infinity, duration: 1.5, ease: "easeInOut" }}
                                />
                            </div>
                            <span className="text-[10px] font-black tracking-[0.4em] text-white/30 uppercase">Expanding Archive...</span>
                        </div>
                    )}
                    ...
                    {!hasMore && products.length > 0 && (
                        <div className="flex items-center justify-center gap-8 py-32 opacity-60">
                            <div className="h-[1px] w-12 md:w-24 bg-[#d4c4b1]/20"></div>
                            <span className="text-[10px] md:text-xs font-black tracking-[0.6em] text-[#d4c4b1] uppercase">Discovery Feed Complete</span>
                            <div className="h-[1px] w-12 md:w-24 bg-[#d4c4b1]/20"></div>
                        </div>
                    )}
                </div>
