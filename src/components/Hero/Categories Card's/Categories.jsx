  ...
  return (
    <section className="py-[60px] md:py-[120px] bg-background text-text-primary overflow-hidden">
      <div className="max-w-[1800px] mx-auto px-4 md:px-[40px] lg:px-[60px]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-12 auto-rows-[220px] md:auto-rows-[400px] lg:auto-rows-[100px] gap-4 md:gap-8">
          {categoryItems.map((item, index) => {
            const getCardGridClasses = (i) => {
              switch (i) {
                case 1: return "col-span-2 md:col-span-1 md:row-span-1 lg:col-[1/7] lg:row-[1/6]";
                case 2: return "col-span-1 md:col-span-1 md:row-span-1 lg:col-[7/10] lg:row-[1/4]";
                case 3: return "col-span-1 md:col-span-1 md:row-span-1 lg:col-[10/13] lg:row-[1/4]";
                case 4: return "col-span-1 md:col-span-2 lg:col-[7/13] lg:row-[4/9]";
                case 5: return "col-span-1 md:col-span-1 md:row-span-1 lg:col-[1/7] lg:row-[6/9]";
                default: return "";
              }
            };
            return (
                ...
                <div className="relative w-full h-full overflow-hidden">
                  ...
                  <div className="absolute inset-0 p-4 md:p-10 flex flex-col justify-between z-10">
                    <div className="flex justify-between opacity-100 md:opacity-0 md:-translate-y-5 transition-all duration-[0.6s] ease group-hover:opacity-100 group-hover:translate-y-0">
                      <span className="font-oswald text-xs md:text-sm font-bold text-accent">0{index + 1}</span>
                      <span className="text-[8px] md:text-[9px] tracking-[0.2em] md:tracking-[0.3em] font-black uppercase">SPRING / SUMMER</span>
                    </div>

                    <div className="content-bottom">
                      <h3 className="font-oswald text-xl md:text-[32px] font-black tracking-[-0.02em] uppercase mb-1 md:mb-3 transform md:translate-y-5 transition-transform duration-[0.6s] ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:translate-y-0">{item.title}</h3>
                      <div className="flex items-center gap-4 opacity-100 md:opacity-0 md:translate-y-2.5 transition-all duration-[0.6s] ease delay-100 group-hover:opacity-100 group-hover:translate-y-0">
                        <span className="text-[8px] md:text-[10px] font-black tracking-[0.2em] md:tracking-[0.4em] text-accent">THE ARCHIVE</span>
                        <div className="w-[20px] md:w-0 h-[1px] bg-accent transition-[width] duration-[0.6s] ease delay-100 group-hover:w-[40px]"></div>
                      </div>
                    </div>
                  </div>
                </div>
